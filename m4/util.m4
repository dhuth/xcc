...
m4_define(`__m4_argn',                                          `m4_ifelse(`$1', `1', `$1', `__m4_argn(m4_eval($1 - 1), m4_shift(m4_shift($*)))')')
m4_define(`__m4_for',                                           `m4_define(`$1', `$2')$4`'m4_ifelse(`$2', `$3', `',
                                                                    `$0(`$1', m4_incr(`$2'), `$3', `$4')')')
...
m4_define(`__m4_list_map',                                      `m4_with(`__list_len',`m4_list_len($2)',
                                                                    `m4_ifelse(__list_len, `0', `',
                                                                               __list_len, `1', `m4_define(`$1', m4_list_first($2))$3', 
                                                                                                `m4_define(`$1', m4_list_first($2))$3, $0(`$1', m4_list_rest($2), `$3')')')')
...
m4_define(`m4_list_map',                                        `m4_pushdef(`$1')m4_list(__$0($@))m4_popdef(`$1')')
