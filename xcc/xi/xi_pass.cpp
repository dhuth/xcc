...
static inline void begin_pass(xi_builder& builder, tree_type_id id, ast_tree* t) {
    switch(id) {
    case tree_type_id::ast_namespace_decl:  builder.push_namespace(t->as<ast_namespace_decl>());    break;
...
static inline void end_pass(xi_builder& builder, tree_type_id id, ast_tree* t) {
    switch(id) {
